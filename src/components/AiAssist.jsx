...
const AiAssist = ({ onJsonResponse }) => {
  ...
  // Hardcoded API key (should be stored securely in environment variables for production)
  const apiKey =
    "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";
